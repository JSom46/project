    ...
    return(
      //<NavigationContainer>
        <MyAnnouncementsStack.Navigator screenOptions={{headerShown: false}}>
          <MyAnnouncementsStack.Screen name="Lista moich ogloszen" component={MyAnnouncementsScreen}/>
          <MyAnnouncementsStack.Screen name="Ogloszenie" component={AnnouncementView}/>
          <MyAnnouncementsStack.Screen name="Dodaj Ogloszenie" component={AddAnnouncement}/>
