...
INSERT INTO "anons" ("id","title","description","category","images","author_id","create_date","lat","lng","type","coat","color","breed","is_active") VALUES (1,'Zaginął kot','Kot rasy egipskiej, czarny, nagroda za znalezienie - kot dachowy',3,'',3,20220302,21.0,56.0,'1','','','',0),
 (2,'Pie żre kiełbasę','Kto to widział, żeby wędliny marnować',2,'',2,20220304,56.0,85.0,'2','','','',0),
 (3,'Papuga uciekłą0','Ara zielona zwiała i nie chce wracać, ktoś widział?',3,'',3,20220307,16.0,43.0,'3',NULL,NULL,NULL,0);
INSERT INTO "ChatMessages" ("message_id","anons_id","chat_id","user_id","message_date","message_text") VALUES (1,1,4,4,20220301,'ala ma kota'),
...
INSERT INTO "users" ("id","login","password","email","activation_code","is_activated","is_native","is_admin","last_active_time") VALUES (1,'admin','$2b$10$5.DxSmB19Bh86KyryAZo7.2GT9eDRm3VgFCMye6Wm/p0HzsYAI2ru','admin@trash-mail.com',NULL,1,1,1,NULL),
...
INSERT INTO "ChatUsers" ("anons_id","chat_id","user_id","last_seen_time") VALUES (1,4,3,NULL),
 (1,4,4,NULL),
 (1,5,3,NULL),
 (1,5,5,NULL),
 (2,3,2,NULL),
