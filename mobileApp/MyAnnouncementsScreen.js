...
async function getAnnouncements(){
    try {
        let response = await fetch('http://'+ adresSerwera +':2400/anons/my');
...
const Announcement = ({ title, image, category }) => (
    <View style={stylesAnnouncements.announcementListItem}>
        <Image style={stylesAnnouncements.announcementListItemPhoto} source={{uri: 'http://'+adresSerwera+':2400/anons/photo?name=' + image}}/>
        <View style={{flex: 1}}>
